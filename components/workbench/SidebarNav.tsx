...
function SidebarNavInner() {
  return (
    <nav className="ns-panel flex gap-1 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] lg:sticky lg:top-0 lg:max-h-[min(100vh-2rem,48rem)] lg:flex-col lg:overflow-y-auto lg:overflow-x-visible lg:rounded-sm lg:border lg:p-3 [&::-webkit-scrollbar]:hidden">
